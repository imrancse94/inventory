<header class="header">
    <div class="page-brand">
            ...
            <span class="brand"><img src="{{asset($cache)}}" alt=""></span>
        ...
        <ul class="nav navbar-toolbar">
            <li class="timeout-toggler">
                ...
                if (Config::get('app.locale') =="en"){
                    $img = "adminca/assets/img/flags/uk.png";
                }
                else{
                    $img = "adminca/assets/img/flags/turkey.png";
                }
                ?>


                <a class="dropdown-toggle" data-toggle="dropdown"><span style="padding-right: 10px;"><img src="{{asset($img)}}" > </span><i class="ti-more-alt"></i></a>
                {{--<i class="ti-more-alt"></i>--}}
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="{{ url('lang/en') }}" id="en"><img src="{{asset('adminca/assets/img/flags/uk.png')}}" >&nbsp;&nbsp;English</a>
                    <a class="dropdown-item" href="{{ url('lang/tr') }}" id="tr"><img src="{{asset('adminca/assets/img/flags/turkey.png')}}" >&nbsp;&nbsp;Türkiye</a>
            ...
            {{--<a class="media p-3">--}}
            {{--<div class="media-img">--}}
            {{--<img class="img-circle" src="{{asset('adminca')}}/assets/img/users/u8.jpg" alt="image" />--}}
            {{--</div>--}}
            ...
            {{--<a class="media p-3">--}}
            {{--<div class="media-img">--}}
            {{--<img class="img-circle" src="{{asset('adminca')}}/assets/img/users/u6.jpg" alt="image" />--}}
            {{--</div>--}}
            {{--<div class="media-body">--}}
            ...
            {{--<a class="media p-3">--}}
            {{--<div class="media-img">--}}
            {{--<img class="img-circle" src="{{asset('adminca')}}/assets/img/users/u11.jpg" alt="image" />--}}
            {{--</div>--}}
            {{--<div class="media-body">--}}
            ...
            {{--<a class="media p-3">--}}
            {{--<div class="media-img">--}}
            {{--<img class="img-circle" src="{{asset('adminca')}}/assets/img/users/u10.jpg" alt="image" />--}}
            {{--</div>--}}
            {{--<div class="media-body">--}}
            ...
            {{--<a class="media p-3">--}}
            {{--<div class="media-img">--}}
            {{--<img class="img-circle" src="{{asset('adminca')}}/assets/img/users/u2.jpg" alt="image" />--}}
            {{--</div>--}}
            {{--<div class="media-body">--}}
            ...
            {{--<a class="media p-3">--}}
            {{--<div class="media-img">--}}
            {{--<img class="img-circle" src="{{asset('adminca')}}/assets/img/users/u5.jpg" alt="image" />--}}
            {{--</div>--}}
            {{--<div class="media-body">--}}
            ...
            {{--<a class="media p-3">--}}
            {{--<div class="media-img">--}}
            {{--<img class="img-circle" src="{{asset('adminca')}}/assets/img/users/u9.jpg" alt="image" />--}}
            {{--</div>--}}
            {{--<div class="media-body">--}}
            ...
            <li class="dropdown dropdown-user">
                <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                    ...
                    @if(file_exists(public_path().'/'.Auth::user()->img_path) && !empty(Auth::user()->img_path))
                        <img src="{!! asset(Auth::user()->img_path) !!}" alt="image" />
                    @else
                        <img src="{!! asset('uploads/user_photo/avatar.PNG') !!}" alt="image" />
                    @endif
                ...
                <div class="dropdown-menu dropdown-arrow dropdown-menu-right admin-dropdown-menu">
                    ...
                    <div class="dropdown-header">
                        <div class="admin-avatar">
                            {{--@if(file_exists(public_path().'/'.Auth::user()->company->logo) && !empty(Auth::user()->company->logo))--}}
                                {{--<img src="{!! asset(Auth::user()->company->logo) !!}" alt="image" />--}}
                            {{--@else--}}
                                {{--<img src="{!! asset('uploads/user_photo/avatar.PNG') !!}" alt="image" />--}}
                            {{--@endif--}}
                    ...
                    <div class="admin-menu-features">
                        <a class="admin-features-item" href="{{route('profile.edit.get', 'profile')}}">
                            @if(file_exists(public_path().'/'.Auth::user()->img_path) && !empty(Auth::user()->img_path))
                                <img src="{!! asset(Auth::user()->img_path) !!}" alt="image" width="auto" height="46" />
                            @else
                                <img src="{!! asset('uploads/user_photo/avatar.PNG') !!}" alt="image" width="auto" height="46" />
                            @endif
                        ...
                        {{--<span>SUPPORT</span>--}}
                        {{--</a>--}}
                        <a class="admin-features-item border-right-0" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="ti-lock text-danger"></i>
                    ...
                    {{--<a class="d-flex align-items-center" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout<i class="ti-shift-right ml-2 font-20"></i></a>--}}
                    {{--<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">--}}
                    {{--@csrf--}}
                    {{--</form>--}}
                    {{--</div>--}}
