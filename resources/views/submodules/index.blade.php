        ...
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">
                    {{__($cmsInfo['subModuleTitle'])}} <a href="{{route('submodules.create')}}" class="ml-3 btn btn-sm btn-primary pull-right"> <i class="fa fa-plus-circle"></i> {{__('Add')}}</a>
                </div>
            </div>
            <div class="ibox-body">
                            ...
                            @foreach($submodules as $submodule_id => $submodule)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="text-muted font-16 mr-2" href="{{route('submodules.edit', $submodule->id)}}">
                                            <i class="ti-pencil-alt"></i>
                                        </a>
                                        <a class="text-muted font-16 mr-2" href="{{route('submodules.view', $submodule->id)}}">
                                            <i class="ti-eye"></i>
                                        </a>
                                        <a class="text-muted font-16 mr-1 ml-1" data-id="{{$submodule->id}}"  href="#" onclick="deleteAction('delete-form-{{$submodule->id}}')">
                                            <i class="ti-trash"></i>
                                        </a>
