                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group {{$errors->has('sub_module_id') ? 'has-error':''}}">
                                            ...
                                            <select class="form-control select2" name="sub_module_id" id="sub_module_id" required>
                                                <option value="" selected disabled>{{__('Please select')}}</option>
                                        ...
                                        <div class="form-group {{$errors->has('available_to_company') ? 'has-error':''}}">
                                            <label class="checkbox checkbox-ebony">
                                                <input style="margin-left:0;" type="checkbox" name="available_to_company" id="available_to_company" value="1">
                                                <span class="input-span" style="margin-left: 20px;">{{__('Available To Company')}}</span>
                                            </label>
