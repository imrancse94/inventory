...
<div class="page-content fade-in-up">
    ...
    <div class="ibox">
        <form action="{{route('usergrouprole.modify')}}" method="post">
            @csrf
            <div class="ibox-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="box-body">
                            <div class="form-group mb-4">
                                ...
                                <select class="form-control" name="usergroup_id" id="company-usergroup" required>
...
<script>
    ...
    $(document).on('click', '.notsel', function() {
        $('#sulist').append('<li class="list-group-item flexbox seltd" data="'+$(this).attr("data")+'"><input type="hidden" name="selected_roles[]" value="'+$(this).attr("data")+'" /> '+$(this).text()+'</li>');
        $(this).remove();
    });
    ...
    $(document).on('change', '#company-usergroup', function () {
        ...
        if(selectedValue) {
            $.ajax({
                type: "GET",
                url: '{{url("usergroup-role-association/getassociation/")}}/'+selectedValue,
                dataType: "json",
                success: function (response) {
                    $('#loader').addClass('d-none');
                    $('#swap-roles').html(response.role_content);
                },
